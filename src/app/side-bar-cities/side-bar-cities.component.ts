...
@Component({
  selector: 'app-side-bar-cities',
  templateUrl: './side-bar-cities.component.html',
  styleUrls: ['./side-bar-cities.component.scss']
})
export class SideBarCitiesComponent implements OnInit {
